...
ADDITIONAL_METADATA = dict(
    ...
    frequency='daily',
    dependencies='climate-tasmax-NASA_BCSD-originals.1.0')
...
def create_polynomial_transformation(power=2):
    ...
    varname = 'tasmax-poly-{}'.format(power) if power > 1 else 'tasmax'
    ...
    def tasmax_poly(ds):
        ...
        # do transformation
        ds1[varname] = (ds.tasmax - 273.15)**power
    ...
    tasmax_poly.__doc__ = description

    transformation_spec = {
        'variable': varname,
        'source_variable': 'tasmax',
        'transformation': tasmax_poly,
