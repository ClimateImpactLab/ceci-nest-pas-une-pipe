...
WRITE_PATH = os.path.join(
    '/global/scratch/jsimcock/gcp/climate/data_test_outputs_two',
...
JOBS = [
    #dict(transformation_name='tasmax-over-95', variable='tasmax',transformation=tasmax_over_95F), 
    dict(transformation_name='tasmax-over-95-365day', variable='tasmax',transformation=tasmax_over_95F_365day)
    ] 
